...
contract EventTicketsV2 {
    ...
    */
    function addEvent(string memory _description, string memory _website, uint _numberOfTickets) public isOwner returns(uint) {
        ...
        // how to get the eventId to map to an Event in the mapping events? 
    ...
    */
    function getRefund(uint _eventId) public payable {
        ...
        - check that a user has purchased tickets for the event
            ...
            - emit the appropriate event
        */ 
        //iterate through the buyers mapping in the Event struct to see if the buyer exists in the Event and that the amount of tickets purchased >= 1
